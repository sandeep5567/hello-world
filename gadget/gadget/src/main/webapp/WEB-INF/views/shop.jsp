    ...
    <div class="container">
        ...
        <section class="container" ng-app="cartApp">
            ...
            <div ng-controller = "cartCtrl" ng-init="initCartId('${cartId}')">
                ...
                <div>
                    <a href="#" class="btn btn-danger pull-left" ng-click = "clearCart(item.product.productId)"><span class="glyphicon glyphicon-remove-sign"></span> Clear Cart</a>
                ...
                <table class="table table-hover">
                    ...
                    <tr ng-repeat = "item in cart.cartItems">
                        ...
                        <th>&#8377 {{item.product.productPrice}}</th>
                        <th>{{item.quantity}}</th>
                        <th>&#8377 {{item.totalPrice}}</th>
